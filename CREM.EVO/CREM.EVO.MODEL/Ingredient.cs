...
namespace CREM.EVO.MODEL
{
    ...
    public class Ingredient_Filter_Brew_extern:NotificationObject
    {
        ...
        public UInt16 UsedTime
        {
            get
            {
                return (UInt16)(WaterVolume + Grind1Cnt/10+ Grind2Cnt/10);
            }
            set { }
        }
    }
    ...
    public class Ingredient_InstantPowder_extern:NotificationObject
    {
        ...
        private UInt16 _preflushTm;
        [XmlAttribute("PreFlushTm")]
        public UInt16 PreFlushTm
        {
            get { return _preflushTm; }
            set { if (value != _preflushTm) { _preflushTm = value; this.RaisePropertyChanged("PreFlushTm");} }
        }
        private UInt16 _postflushTm;
        [XmlAttribute("PostFlushTm")]
        public UInt16 PostFlushTm
        {
            get { return _postflushTm; }
            set { if (value != _postflushTm) { _postflushTm = value; this.RaisePropertyChanged("PostFlushTm"); } }
        }
        ...
        public UInt16 UsedTime
        {
            get
            {
                return (UInt16)(_PreFlush + _AfterFlush + _WaterVolume+ PackageOneAmt/10+ PackageTwoAmt/10);
            }
            set { }
        }
