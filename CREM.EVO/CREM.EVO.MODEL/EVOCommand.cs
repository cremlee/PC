...
namespace CREM.EVO.MODEL
{
    ...
    public class M2BClean : IComCmd
    {
        ...
        public static byte CleanDaily   = 0x05;
        public static byte CleanValve   = 0x06;
        public static byte CleanWeekly  = 0x07;
        public static byte CleanWater   = 0x08;
        public static byte FlushBrew    = 0x09;
        public static byte CleanMilkPrime  = 0x04;
        public static byte CleanBrewFliter = 0x10;
    ...
    public class M2BFinishClean : IComCmd
    {
        public byte[] EnCode()
        {
            return new byte[1] { 0x04 };
        }
    }
    ...
    {
        public static byte TYPE_FILE =0x80;
        public static byte TYPE_Program = 0x80;
    ...
    public class M2BDbGeting :IComCmd
    {
        public byte DBCnt { get; set; }
        public List<byte> IDList { get; set; }
        public M2BDbGeting()
        {
        ...
        CAL_COLD_WATER=0x84,
        CAL_HOT_WATER=0x85,
        CAL_CARBON_WATER=0x86,
        CAL_POWDER_GRINDER1=0x87,
        CAL_POWDER_GRINDER2 = 0x88,
        CAL_POWDER_CANISTER1 =0x89,
        CAL_POWDER_CANISTER2 = 0x8a,
        CAL_POWDER_CANISTER3 = 0x8b,
        CAL_POWDER_CANISTER4 = 0x8c,
        CAL_TEMP_TANK=0x8d,
        CAL_BREW_UPTM=0x8e,
        CAL_BREW_DOWNTM=0x8f,
        CAL_BREW_TSTTM=0x90,
        DATE_YEAR =0x91,
        DATE_MONTH_DAY = 0x92,
        DATE_HOUR_MIN = 0x93,
        ...
        VERSION_FIRM =0x96,
        MACHINE_TYPE =0x97*/
        public byte[] GetMachineSettingCmd()
        {
            DBCnt = 0;
            foreach (DBDefine item in Enum.GetValues(typeof(DBDefine)))
            {
                DBCnt++;
                IDList.Add((byte)item);
            }
            return EnCode();
        }
    ...
    public class M2BLedClrSet
    {
        ...
        public byte OperationCmd { get; set; }
        public EVOLedColor setcolor { get; set; }

        public byte[] EnCode()
        {
            return new byte[] {0x17, this.OperationCmd, this.setcolor.ColorNB, this.setcolor.Color.RED, this.setcolor.Color.GREEN, this.setcolor.Color.BLUE };
        }
    }
    public class B2MColorSet
    {
        public byte operationCmd { get; set; }
        public byte colorNumber { get; set; }
        public byte Result { get; set; }
        public B2MColorSet(byte[] inbuf, int index)
        {
            int pos = index + 1;
            operationCmd = inbuf[pos++];
            colorNumber = inbuf[pos++];
            Result = inbuf[pos];
        }
    }
    ...
    public class B2MFinishClean
    {
        public byte Result { get; set; }
        public B2MFinishClean(byte[] inbuf, int index)
        {
            int pos = index + 1;
            Result = inbuf[pos];
        }
    ...
    public enum CleanType
    {
        CLEAN_DAILY = 0x401,
        CLEAN_WEEKLY = 0x402,
        CLEAN_WATERFLUSH = 0x403,
        CLEAN_FLUSH_BREW = 0x404,
        CLEAN_CLEAN_BREW = 0x405,
        CLEAN_CLEAN_MIXER = 0x406,
        CLEAN_CLEAN_VALVE = 0x407,
        CLEAN_CLEAN_GRINDER = 0x408,
        CLEAN_OPEN_BREW = 0x409
    }
    ...
    public class SensorState
    {
        ...
        public SensorState(byte a)
        {
            ...
            waterlevel = (byte)((a & 0x7f) >> 5);
            brew_sw = ((a & 0x80) == 0x80 ? true : false);
        }
    ...
    public class M2BFctoryRst
    {
        public byte[] EnCode()
        {
            return new byte[1] { 0x15 };
        }
    }

    public class B2MFctoryRst
    {
        public byte Result { get; set; }
        public B2MFctoryRst(byte[] inbuf, int index)
        {
            int pos = index;
            Result = inbuf[pos];
        }
    ...
    public enum CmdType
    {
        ...
        M2B_CMD_CLEAN = 0x02,
        B2M_CMD_CLEAN = 0x82,
        M2B_CMD_STOP_CLEAN = 0x03,
        B2M_CMD_STOP_CLEAN = 0x83,
        M2B_CMD_FINISH_CLEAN = 0x04,
        B2M_CMD_FINISH_CLEAN = 0x84,
        ...
        M2B_CMD_CAL = 0x11,
        B2M_CMD_CAL = 0x91,
        M2B_CMD_COLOR_SET=0x17,
        B2M_CMD_COLOR_SET = 0x97,
        M2B_CMD_DB_GET = 0x14,
        B2M_CMD_DB_GET = 0x94,
        M2B_CMD_RST=0x15,
        B2M_CMD_RST = 0x95
